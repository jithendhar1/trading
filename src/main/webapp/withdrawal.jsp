...
// page
int recordcount = WithdrawalDAO.totalCount();

noOfPages = (int) Math.ceil((double) recordcount / limit);
// pagee
if (!whereClause.isEmpty()) {
    // Apply the whereClause condition
	 tax = WithdrawalDAO.getFilteredWithdrawals(whereClause, start, limit);
} else {
    // Retrieve all data based on the limit
	tax = WithdrawalDAO.getFilteredWithdrawals("", start, limit);
}
