                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<a href="#" class="btn add-btn" data-toggle="modal" data-target="#addvechicle"><i class="fa fa-plus"></i> Add Deposit</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
...
<div class="row justify-content-center align-items-center" id = "flag1">
   ...
   <!-- Pagination links -->
    ...
    <% if (pageno > 1) { %>
        <a href="deposit.jsp?page=<%=pageno - 1%>">Previous</a>
    <% } %>
    ...
    <% for (int i = 1; i <= noOfPages; i++) { %>
        <% if (i == pageno) { %>
            <%=i%>
        <% } else { %>
            <a href="deposit.jsp?page=<%=i%>"><%=i%></a>
        <% } %>
    <% } %>

    <% if (pageno < noOfPages) { %>
        <a href="deposit.jsp?page=<%=pageno + 1%>">Next</a>
    <% } %>
