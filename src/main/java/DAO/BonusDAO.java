	 ...
	 public static List<TransactionBean>getWithdrawalsByUsername(String username) {
		    ...
		    try {
		        ...
		        if ("Admin".equals(username)) {
		            ...
		            String adminQuery = "SELECT UserID, transactiondate,status, TransactionID, Amount,ReferralID FROM transaction where Transactiontype='Bonus'";
		            ...
		            if (userResultSet.next()) {
		                ...
		                depositStatement.setString(1, username);
		            }
