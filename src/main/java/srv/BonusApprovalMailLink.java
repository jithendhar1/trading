...
public class BonusApprovalMailLink {
	...
	public static void sendLinkEmail(String toEmail,String ReferredUserID,String ReferrerName) {
		...
		String subject = "Trade System Referral Bonus Program.";
		String body = "Hi"+  ReferrerName + '\n'
				+ "Please find the Referral Bonus Status APPROVAL link for Amount in our trading system. "
				+ "http://localhost:8083/trading/referrals_user.jsp?userid="+ReferredUserID;
