...
public class DepositApprovalMailLink {
	...
	public static void sendLinkEmail(String toEmail,String ReferredUserID,String ReferrerName) {
		...
		String subject = "Trade System Deposit Program.";
		String body = "Hi"+  ReferrerName + '\n'
				+ "Please find the Deposit Status APPROVAL link for Amount in our trading system. "
				+ "http://localhost:8083/trading/deposit_user.jsp?userid="+ReferredUserID;
